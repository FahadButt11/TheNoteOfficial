...
<div className="flex gap-2">
  ...
  <a href="https://www.instagram.com/thenote_official/?igsh=aTJpNTQzeDhiYjU1&utm_source=qr#">
    ...
    <div className="relative group w-[3rem] h-[3rem] rounded-full bg-[#25D366] shadow-lg flex justify-center items-center overflow-hidden hover:scale-125 transition-transform duration-500 ease-in-out">
