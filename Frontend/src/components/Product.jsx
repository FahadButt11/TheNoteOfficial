...
const ProductGrid = () => {
  const products = [
    { id: 1, name: 'WHISPER', src: 'male_1.webp', soldOut: false },
    { id: 2, name: 'DUSK', src: 'male_2.webp', soldOut: false },
    { id: 3, name: 'WOODS', src: 'male_3.webp', soldOut: false },
    { id: 4, name: 'INTENSO', src: 'male_4.webp', soldOut: false },
  ];
